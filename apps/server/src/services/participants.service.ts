...
/**
 * Join a course as a participant.
 * - If authenticated (userId present), creates a REGISTERED participant
 *   or returns existing one.
 * - If no userId, creates an ANONYMOUS participant with a generated ID.
 */
